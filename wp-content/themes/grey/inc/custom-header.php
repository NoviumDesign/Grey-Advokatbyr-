 ...
 *
 * @uses grey_header_style()
 * @uses grey_admin_header_style()
 * @uses grey_admin_header_image()
 */
function grey_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'grey_custom_header_args', array(
		...
		'admin-preview-callback' => 'grey_admin_header_image',
	) ) );
}
 ...
 * @see grey_custom_header_setup().
 */
function grey_admin_header_style() {
?>
	<style type="text/css">
...
endif; // grey_admin_header_style

if ( ! function_exists( 'grey_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see grey_custom_header_setup().
 */
function grey_admin_header_image() {
